...
def plot_verification(estimators, X, y, 
                      ...
                      X_baseline=None, 
                      n_boot=10, style='classification', SRSPlot=False):
    ...
    for ax, metric in zip(axes.flat, metrics):
        ...
        verify.plot(diagram=metric, x=xp, y=yp, ax=ax, scores=scores, pred=pred, SRSPlot=SRSPlot)
...
class VerificationDiagram:
    ...
    def plot(self, diagram, x, y,
             ...
             line_colors=None,
             diagram_kwargs={}, 
             plot_kwargs={}, ax=None, SRSPlot=False): 
        """
        ...
        if SRSPlot:
            line_colors = ['r', 'b', 'g', 'orange',  'yellow', 'cyan', 'm', '#008000','k']
        else:
